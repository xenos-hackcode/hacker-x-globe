// app/(auth)/(developer)/loading-developer.tsx
...
const PHASES = [
  ...
  "Loading projects and assets...",
  "Syncing developer profile...",
  "Connecting to live nodes...",
  "Preparing build pipelines...",
...
export default function DeveloperLoadingScreen() {
  ...
  useEffect(() => {
    if (phase === PHASES.length - 1) {
      const t = setTimeout(() => {
        router.replace("/(auth)/(developer)/home");
      }, 2500);
      ...
      <Animated.View style={[styles.panelOuter, panelAnimatedStyle]}>
        <View style={styles.panelInner}>
          ...
          <View style={styles.logoBlock}>
            ...
            <Text style={styles.logoTitle}>CEDAL / DEVELOPER NODE</Text>
            <Text style={styles.logoSubtitle}>DEVELOPER CHANNEL</Text>
          </View>
          ...
          <View style={styles.statusBlock}>
            <Text style={styles.statusLabel}>
              ...
              <Text style={styles.statusValue}>
                {phase < PHASES.length - 1 ? "PREPARING" : "READY"}
              </Text>
            </Text>
          ...
          <View style={styles.logsShell}>
            ...
            <View style={styles.logsList}>
              {[
                { text: "Developer handshake", minPhase: 1 },
                { text: "Projects loaded", minPhase: 2 },
                { text: "Build pipelines ready", minPhase: 4 },
                { text: "Console unlocked → LON-01", minPhase: 5 },
              ].map((log, idx) => {
          ...
          <View style={styles.regionBlock}>
            <Text style={styles.regionText}>
              REGION: LON-01  ·  CHANNEL: DEV-BOOT-01
            </Text>
          </View>
        </View>
      </Animated.View>
...
// Copy the exact same styles from your MemberLoadingSignInScreen
