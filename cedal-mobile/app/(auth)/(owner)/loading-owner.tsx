// app/(auth)/(owner)/loading-owner.tsx
...
const PHASES = [
  "Establishing owner channel...",
  "Loading workspace configuration...",
  "Syncing team and project topology...",
  "Validating elevated permissions...",
  "Deploying owner control surface...",
  "Owner console online!",
];

export default function OwnerLoadingScreen() {
  ...
  useEffect(() => {
    if (phase === PHASES.length - 1) {
      const t = setTimeout(() => {
        // after owner boot, route wherever owner lands
        router.replace("/(auth)/(owner)/home");
      }, 2500);
      ...
      <Animated.View style={[styles.panelOuter, panelAnimatedStyle]}>
        <View style={styles.panelInner}>
          ...
          <View style={styles.logoBlock}>
            ...
            <Text style={styles.logoTitle}>Member / OWNER NODE</Text>
            <Text style={styles.logoSubtitle}>OWNER CHANNEL</Text>
          </View>
          ...
          <View style={styles.statusBlock}>
            <Text style={styles.statusLabel}>
              ...
              <Text style={styles.statusValue}>
                {phase < PHASES.length - 1 ? "BOOTING" : "ONLINE"}
              </Text>
            </Text>
          ...
          <View style={styles.logsShell}>
            ...
            <View style={styles.logsList}>
              {[
                { text: "Owner link handshake", minPhase: 1 },
                { text: "Workspace config loaded", minPhase: 2 },
                { text: "Privileges validated", minPhase: 4 },
                {
                  text: "Owner console unlocked → LON-01",
                  minPhase: 5,
                },
              ].map((log, idx) => {
          ...
          <View style={styles.regionBlock}>
            <Text style={styles.regionText}>
              REGION: LON-01  ·  CHANNEL: OWNER-BOOT-01
            </Text>
          </View>
        </View>
      </Animated.View>
